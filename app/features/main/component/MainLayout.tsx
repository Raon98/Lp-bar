        ...
        <>
          ...
          >
            <div className="flex w-full h-screen relative">
              ...
              {mount && <div className="w-full h-full flex items-center justify-center ">
              ...
              <div className="relative w-[55%] animate-fadeIn x-1100:w-full">
                ...
                <div
                  className={cn('absolute left-[19%] top-[26%] w-[45%] hover:cursor-pointer drag_item hover:animate-lpSpin',
            ...
            <div className="mx-[2rem] mb-[3rem] my-auto flex items-end justify-between text-white ">
              ...
              >
                <img
                  ...
                  alt="boxIcon"
                  className={cn(`bg-no-repeat bg-transparent bg-center object-cover`,`${box ? 'w-[70%]' : 'w-1/2'}`)}
                />
              </button>
            </div>
          </div>
