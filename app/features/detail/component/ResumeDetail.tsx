      ...
      <div className="w-full mt-5">
        ...
        <div>
          <div className="mt-3">
            ...
            <div>
              누구에게나 잘하는것이 한 가지씩은 있다고 어른들은 말씀하셨습니다.
              제가 생각했을 때 저는 로직의 대한 정리가 남들보다 빠르다고
              생각합니다. 이를 바탕으로 제 의견을 다른분들께 전달하는데 어려움이
              없고 한번에 해결하지 못하는 문제 또한 머릿속에서 여러가지 로직을
              시뮬레이션 돌려서 실행해보곤 합니다. 머릿속에서 최적한된 코드를
              생각해 보고 해당 코드를 적용시키는 것을 즐거워합니다. 최적화된
              코드들을 모아 제 코드로 습득하다 보면 먼 훗날 저는 프론트엔드에
              최적화된 개발자가 될 것이라 확신합니다.
            </div>
          </div>
